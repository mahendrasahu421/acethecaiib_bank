                ...
                <div class="card card-default">
                    ...
                    <div class="">
                        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ asset('admin/discount') }}" class="btn btn-success">
                                <i class="fas fa-list me-1"></i> Course List
                            </a>
                        </div>

                        <form action="/discount/save" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                    <!-- Left Side -->
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="discount_type" class="form-control select2bs4" required>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number" name="discount_value" class="form-control" min="0"
                                                step="0.01" required placeholder="Enter discount value">
                                        </div>
                                        <div class="form-group mb-3">
                                            <label>Status</label>
