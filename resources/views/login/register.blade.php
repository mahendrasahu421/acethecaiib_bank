...
<head>
    ...
    <script data-cfasync="false" nonce="dfa18974-0ece-4770-9ee8-521212962266">
        try {
            (function(w, d) {
                ! function(fv, fw, fx, fy) {
                    if (fv.zaraz) console.error("zaraz is loaded twice");
                        ...
                        fv.zaraz._v = "5858";
                        fv.zaraz._n = "dfa18974-0ece-4770-9ee8-521212962266";
                        fv.zaraz.q = [];
            ...
            <div class="card-body register-card-body">
                ...
                <form action="#" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <a href="{{ url('dashbaord') }}"> <button type="submit"
